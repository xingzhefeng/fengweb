...
Two middleware functions are provided by default in the `myweb.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `myweb.handler` namespace to manage the enabled middleware.
